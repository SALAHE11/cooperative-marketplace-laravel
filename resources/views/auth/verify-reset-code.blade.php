...
@section('title', 'Vérification du code - Coopérative E-commerce')
            ...
            <div class="card">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="h3 mb-3">Vérification du code</h2>
                        <p class="text-muted">
                    ...
                    <div class="alert alert-info mt-4">
                        ...
                        Une fois le code vérifié, vous pourrez définir votre nouveau mot de passe.
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function resendCode() {
        ...
        .catch(error => {
            ...
            showAlert('danger', 'Erreur lors du renvoi du code');
        });
    }
