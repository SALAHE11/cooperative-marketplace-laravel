...
@section('title', 'Vérification Email Administrateur - Coopérative E-commerce')
            ...
            <div class="card">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="h3 mb-3">Vérification Email Administrateur</h2>
                        <p class="text-muted">
                    ...
                    <form method="POST" action="{{ route('admin.verify-email.submit') }}" id="verifyForm">
                        @csrf
                    ...
                    <div class="alert alert-info mt-4">
                        ...
                        Une fois votre email vérifié, vous aurez accès aux fonctionnalités d'administration de la plateforme.
                    </div>
                </div>
            </div>
        </div>
