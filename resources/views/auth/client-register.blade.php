...
@section('title', 'Inscription Client - Coopérative E-commerce')
            ...
            <div class="card">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="h3 mb-3">Inscription Client</h2>
                    ...
                    <form method="POST" action="{{ route('client.register') }}" id="clientRegisterForm">
                        @csrf
